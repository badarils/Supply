<?php $current = 'flooring-granite' ?>
<?php include "../header.php" ?>   

<!--- content -->  
<div ng-app="Avish_Calc" ng-controller="Flooring_granite_marble_ctrl">
               ...
               <div class="row select-box col4_select-box"><!--for types -->
                    ...
                    <div class="col-md-3 col-sm-5 col-xs-12">
                         <div class="form-group">
                              ...
                              <select class="form-control" id="category"  ng-model="selectedcategory" ng-options="y.typeOfWork for (x, y) in datas.graniteAndMarble" ng-change="GetSelectedCategary()">
                    ...
                    <div class="col-md-3 col-sm-5 col-xs-12">
                         <div class="form-group">
                              <h6>Select a Size: </h6>
                              <select class="form-control" id="sel3"  ng-disabled="!selectedtype" ng-model="selectedsize" ng-options="x for (x, y) in selectedtype.slabSizes[0]">
                         ...
                         <div  data-ng-repeat="choice in choices" class="col-md-12 col-sm-12 col-xs-12 bottom-line no-gap" >
                              ...
                              <div class="row walls top-gap">
                                   ...
                                   <div class="form-group col-md-3 col-sm-3 col-xs-12">
                                        ...
                                        <input type="text" class="form-control text-red bold" id="length"  ng-disabled="!selectedsize" ng-model="choice.l2" min="0" max="999" maxlength="6"  step="0.01">
                                   </div>
                                   <div class="form-group col-md-3 col-sm-3 col-xs-12">
                              ...
                              <div class="col-md-12 col-sm-12 col-xs-12 step-result no-gap top-gap bottom-gap grey-box">
                                   ...
                                   <div class="col-md-12 no-gap">
                                        ...
                                        <div class="col-md-12" style="border-bottom: 1px solid #989898;">
                                             <p><b>Total Work Area is</b> <span style="font-size: 15px;color: #BD4931;margin-left: 5px;font-style: normal;"> {{(sum()) | number : 2}} </span><span class="small-text" style="font-style: normal">Sq {{data.selectedOption.name}}</span></p>
                                        </div>
                                        <div class="col-md-12 no-gap" style="  background-color: #fff;">
                                             <div class="col-md-4 col-sm-2 col-xs-12 output-border">
                                                  <p>Total  </p>
                                                  <h3> {{Math.ceil(((sum() *selectedtype.coeffecient.material) / ((selectedsize.l) * (selectedsize.b)))) | number:0}}  <label> Slab</span></h3>
                                             </div>
                                             <div class="col-md-4 col-sm-2 col-xs-12 output-border">
                                                  <p>Cement </p>
                                                  <h3>{{Math.ceil((sum() * selectedtype.coeffecient.material * selectedtype.coeffecient.cement)) | number:0}}<label> Bags</label></h3>
                                             </div>
                                             <div class="col-md-4 col-sm-2 col-xs-12 output-border">
                                                  <p>Sand </p>
                                                  <h3>{{(sum() * selectedtype.coeffecient.material * selectedtype.coeffecient.sand) | number:2}}<label> Cft</label></h3>
                                             </div>
                                        </div>
                                   </div> 
                              </div> 
                              ...
                              <div class="col-md-12 col-sm-12 col-xs-12 step-result no-gap top-gap bottom-gap grey-box">
                                   ...
                                   <div class="col-md-12 no-gap">
                                        ...
                                        <div class="col-md-12 no-gap" style="  background-color: #fff;">
                                                  <div class="col-md-4 col-sm-2 col-xs-12 output-border">
                                                       <p>Total  </p>
                                                       <h3> {{Math.ceil(((sum() * 10.76 * selectedtype.coeffecient.material) / ((selectedsize.l) * (selectedsize.b)))) | number:0}}  <label> Slab</span></h3>
                                                  </div>
                                             <div class="col-md-4 col-sm-2 col-xs-12 output-border">
                                                  <p>Cement</p>
                                                  <h3>{{Math.ceil(((sum() * 10.76 * selectedtype.coeffecient.material) * selectedtype.coeffecient.cement)) | number:0}}<label> Bags</label></h3>
                                             </div>
                                             <div class="col-md-4 col-sm-2 col-xs-12 output-border">
                                                  <p>Sand</p>
                                                  <h3>{{((sum() * 10.76 * selectedtype.coeffecient.material) * selectedtype.coeffecient.sand) | number
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12 step-result no-gap top-gap bottom-gap grey-box">
                                             ...
                                             <div class="col-md-12 no-gap">
                                                  ...
                                                  <div class="col-md-12 no-gap" style="  background-color: #fff;">
                                                       <div class="col-md-4 col-sm-2 col-xs-12 output-border">
                                                            <p>Total  </p>
                                                            <h3> {{Math.ceil(((totalarea() * selectedtype.coeffecient.material) / ((selectedsize.l) * (selectedsize.b)))) | number:0}}<label> Slab</label></h3>
                                                       </div>
                                                       <div class="col-md-4 col-sm-2 col-xs-12 output-border">
                                                            <p>Cement </p>
                                                            <h3>{{Math.ceil((totalarea() * selectedtype.coeffecient.material * selectedtype.coeffecient.cement)) | number:0}}<label> Bags</label></h3>
                                                       </div>
                                                       <div class="col-md-4 col-sm-2 col-xs-12 output-border">
                                                            <p>Sand </p>
                                                            <h3>{{(totalarea() * selectedtype.coeffecient.material * selectedtype.coeffecient.sand) | number
                                                                      :2}}<label> Cft</label></h3>
                                                       </div>
                                                  </div>
                                             </div> 
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12 step-result no-gap top-gap bottom-gap grey-box">
                                             ...
                                             <div class="col-md-12 no-gap">
                                                  ...
                                                  <div class="col-md-12 no-gap" style="  background-color: #fff;">
                                                       <div class="col-md-4 col-sm-2 col-xs-12 output-border">
                                                            <p>Total  </p>
                                                            <h3> {{Math.ceil(((totalarea() * 10.76 * selectedtype.coeffecient.material) / ((selectedsize.l) * (selectedsize.b)))) | number:0}}<label> Slab</label></h3>
                                                       </div>
                                                       <div class="col-md-4 col-sm-2 col-xs-12 output-border">
                                                            <p>Cement </p>
                                                            <h3>{{Math.ceil(((totalarea() * 10.76 * selectedtype.coeffecient.material) *  selectedtype.coeffecient.cement)) | number:0}}<label> Bags</label></h3>
                                                       </div>
                                                       <div class="col-md-4 col-sm-2 col-xs-12 output-border">
                                                            <p>Sand </p>
                                                            <h3>{{((totalarea() * 10.76 * selectedtype.coeffecient.material) * selectedtype.coeffecient.sand) | number
                                                                      :2}}<label> Cft</label></h3>
                                                       </div>
                                                  </div>
                                             </div> 
