	...
	public function pdfAction(){
		...
		else
		{
		  $original_deposit_id = $display_deposit;
			...
			{
			$image = Zend_Pdf_Image::imageWithPath('skin/frontend/sm_market/default/images/pdf/dd.jpg'); 
			...
			{
			$image = Zend_Pdf_Image::imageWithPath('skin/frontend/sm_market/default/images/pdf/cheque.jpg'); 
			$page->drawImage($image, 50, 100, 772, 496);
			...
			{
			$image = Zend_Pdf_Image::imageWithPath('skin/frontend/sm_market/default/images/pdf/cashin.jpg'); 
			$page->drawImage($image, 50, 100, 772, 496);
