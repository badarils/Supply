...
Mage::app();
echo '<div class="col-lg-1 col-md-2 col-sm-2 col-xs-2 inner-nav">';
echo '<ul class="inner-menu">';
echo '<li class="default showhide1"> <a id="showhide1" href="#"><i class="fa fa-bars"></i><span>Shop</span></a> </li>';
...
echo '<div id="menuBLock" class="category-list1" style="display:none;">';
 ...
 echo '<li id="mainNav"><a class="main-nav1" href="JavaScript:void(0)">';
...
echo 'onmouseout="this.src=\''.Mage::getBaseUrl(Mage_Core_Model_Store::URL_TYPE_SKIN).'frontend/default/msupply/images/green.png'.'\'" alt="Green Solutions"/></div>';
    ...
    <ul id="subNavLevel1">';
           ...
           echo '<li><a alt="'.$category2->getName().'" title="'.$category2->getName().'" rel="canonical" href="'.$category2->getUrl().'">'.$category2->getName().'</a>';
            echo '<ul id="subNavLevel2"class="brand-list">';
